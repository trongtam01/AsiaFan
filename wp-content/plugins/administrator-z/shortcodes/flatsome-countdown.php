...
function adminz_countdown_function($atts){    
    ...
    ob_start();
    ?>
    <div class="ux-timer-wrapper row row-<?php echo $rowspacing; ?>">
        <div class="col small-3 cd countdown-item text-center">
        	<div class="col-inner" style="border: 1px solid #ccc;padding: <?php echo $padding; ?>px 0px;">
        ...
        window.addEventListener('DOMContentLoaded', function() {
            (function($){
                if(cookie("adminz_countdown")){
                    ...
                    var future = new Date().getTime()/1000 + <?php echo $timeleft; ?>*60;
