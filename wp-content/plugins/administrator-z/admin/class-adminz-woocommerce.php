		...
		<form method="post" action="options.php">
			...
			<table class="form-table">		
				...
				<tr valign="top">
					...
					<td>
						<input type="checkbox" name="adminz_woocommerce[adminz_woocommerce_remove_select_woo]" <?php if($this->get_option_value('adminz_woocommerce_remove_select_woo',"on") == "on") echo "checked"; ?>> Select 2 script in sidebar filter
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
