...
function related_post_loop_item_element_post_title($loop_post_id, $elementData){
    ...
    <a class="title post_title" <?php echo apply_filters('related_post_element_link_attrs', '', $elementData); ?>  href="<?php echo $post_link; ?>">
        <?php
        if(!empty($icon)):
            ?>
...
function related_post_loop_item_element_post_thumb($loop_post_id, $elementData){
    ...
    <div class="thumb post_thumb">
        <a <?php echo apply_filters('related_post_element_link_attrs', '', $elementData); ?> href="<?php echo $post_link; ?>">
